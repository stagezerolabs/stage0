...
export default function IncomingNamesNotice({ onUseWallet, needsWalletAddressUpdate }: { onUseWallet: (item: RnsIncomingTransfer) => void; needsWalletAddressUpdate: ReadonlySet<string> }) {
  ...
  return <section ref={panel} id="incoming-names" aria-label="Received names" className="scroll-mt-24 rounded-2xl border border-border bg-canvas-alt p-4 sm:p-5">
    ...
    <p className="mt-1 text-sm leading-6 text-ink-muted">These names are now in your wallet. Review them below.</p>
