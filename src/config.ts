...
export function getRnsContractAddresses(chainId?: number): RnsContractAddressMap {
  return RNS_CONTRACT_ADDRESSES[chainId ?? riseTestnet.id] ?? RNS_CONTRACT_ADDRESSES[riseTestnet.id];
}
...
export const RNSRegistry = [
  ...
  {
    inputs: [
      { internalType: "address", name: "recordOwner", type: "address" },
  ...
  },
  {
    ...
    outputs: [{ internalType: "bytes32", name: "subnode", type: "bytes32" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
...
export const RNSResolver = [
  ...
  {
    inputs: [{ internalType: "bytes32[]", name: "nodes", type: "bytes32[]" }],
    name: "batchAddr",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "string[]", name: "names_", type: "string[]" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [],
    name: "registry",
    outputs: [{ internalType: "contract RNSRegistry", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
...
export const RNSRegistrar = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "newFeePerYear", type: "uint256" }],
    name: "FeeUpdated",
    type: "event",
  },
  {
  ...
  },
  {
    inputs: [],
    name: "resolver",
    outputs: [{ internalType: "contract RNSResolver", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
